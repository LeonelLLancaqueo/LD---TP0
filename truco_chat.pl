...
% definir_muestra//0: toma una carta del mazo y la guarda como muestra.
definir_muestra -->
    tomar_carta(Carta),
    estado(E0, E),
    {
...
jugar_carta(IndiceJugador, Carta) -->
    estado(E0, E),
    {
        select(jugadores(Jugadores0), E0, Resto0),
        quitar_carta_a_jugador(IndiceJugador, Carta, Jugadores0, Jugadores),
